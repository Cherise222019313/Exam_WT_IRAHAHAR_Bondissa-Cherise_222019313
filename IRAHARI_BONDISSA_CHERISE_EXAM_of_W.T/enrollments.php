...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO enrollments(enrollmentID, userID, courseID, enrollment_date) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("isss", $enrollmentID, $userID, $courseID, $enrollment_date);

    // Set parameters and execute
    $enrollmentID = $_POST['Event_ID'];
    $userID = $_POST['Event_Name'];
    $courseID = $_POST['Description'];
    $enrollment_date = $_POST['Start_Date'];
