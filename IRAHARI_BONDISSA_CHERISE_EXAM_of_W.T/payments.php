...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO payments(paymentID, userID, courseID, amount, payment_date) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("issss", $paymentID, $userID, $courseID, $amount, $payment_date);

    // Set parameters and execute
    $paymentID = $_POST['Event_ID'];
    $userID = $_POST['Event_Name'];
    $courseID = $_POST['Description'];
    $amount = $_POST['Start_Date'];
    $payment_date = $_POST['End_Date'];
