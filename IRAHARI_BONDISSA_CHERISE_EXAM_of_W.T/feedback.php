...
<form method="post" onsubmit="return confirmInsert();">
    ...
    <label for="feedback_date">Feedback_date:</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO feedback(feedbackID, userID, courseID, rating, comments,feedback_date) VALUES (?, ?, ?, ?, ?,?)");
    $stmt->bind_param("isssss", $feedbackID, $userID, $courseID, $rating, $comments,$feedback_date);

    // Set parameters and execute
    $feedbackID = $_POST['Event_ID'];
    $userID = $_POST['Event_Name'];
    $courseID = $_POST['Description'];
    $rating = $_POST['Start_Date'];
    $comments = $_POST['End_Date'];
    $feedback_date = $_POST['EndDate'];
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>
            ...
            <td><a style='padding:4px' href='delete_certificates.php?feedbackID=$feedbackID'>Delete</a></td> 
            <td><a style='padding:4px' href='update_certificates.php?feedbackID=$feedbackID'>Update</a></td> 
        </tr>";
    }
